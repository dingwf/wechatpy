...
from wechatx.client import WeChatComponentClient
from wechatx.constants import WeChatErrorCode
from wechatx.crypto import WeChatCrypto
from wechatx.exceptions import APILimitedException, WeChatClientException, WeChatOAuthException, \
    WeChatComponentOAuthException
from wechatx.fields import DateTimeField, StringField
from wechatx.messages import MessageMetaClass
from wechatx.session.memorystorage import MemoryStorage
from wechatx.utils import get_querystring, json, to_binary, to_text, ObjectDict
...
class BaseWeChatComponent(object):
    ...
    def __init__(self,
        ...
        if isinstance(session, six.string_types):
            ...
            from wechatx.session.shovestorage import ShoveStorage
