...
from wechatx.utils import to_text, to_binary, WeChatSigner
from wechatx.exceptions import (
    InvalidAppIdException,
    InvalidSignatureException
)
from wechatx.crypto.base import BasePrpCrypto, WeChatCipher
from wechatx.crypto.pkcs7 import PKCS7Encoder
...
class BaseWeChatCrypto(object):
    ...
    def _encrypt_message(self,
                         ...
                         timestamp=None,
                         crypto_class=None):
        from wechatx.replies import BaseReply
